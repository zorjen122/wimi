...
class GroupService
{
  ...
  private:
    int NotifyMemberJoin(int64_t uid, int64_t groupId, const std::string& requestMessage);
    int NotifyMemberReply(int64_t groupId, int64_t managerUid, int64_t requestorUid, bool accept);
